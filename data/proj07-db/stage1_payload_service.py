...
from task_service_common import build_logger, env_flag, env_float, env_int  # noqa: E402
...
class Stage1PayloadService:
    ...
    builder_script: Path = field(default=SCRIPT_DIR / "build_online_inference_payloads.py")

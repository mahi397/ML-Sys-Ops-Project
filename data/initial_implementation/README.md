...
The final integrated layout is now split between `../proj07-db/` for schema/bootstrap assets and `../proj07-services/` for the running ingest/workflow services. Keep the folders here for lineage tracing, side-by-side comparison, or one-off batch reruns that still depend on the original scripts.
...
- `online_inference_workflow_runtime/`
  - source lineage for `../proj07-services/proj07_services/api/jitsi_transcript_receiver.py`, `../proj07-services/proj07_services/pipeline/ingest_saved_jitsi_transcript.py`, `../proj07-services/proj07_services/pipeline/build_online_inference_payloads.py`, and `../proj07-services/proj07_services/workers/user_summary_materialize_service.py`
- `endpoint_replay_runtime/`
  - source lineage for `../proj07-services/proj07_services/workers/stage1_forward_service.py` and `../proj07-services/proj07_services/workers/stage2_forward_service.py`
- `external_data_training_runtime/`
